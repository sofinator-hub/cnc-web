...
export default function FachadaPremiumPage() {
  return (
    <>
      <MobileMenu />
          ...
          >
            ...
            <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl p-6 md:p-10 max-w-3xl">
              ...
              <p className="uppercase tracking-[0.3em] text-sm text-gray-200 mb-4">
                Fachadas / Arquitectura contemporánea
              </p>
              ...
              <p className="text-gray-200 text-sm md:text-lg leading-relaxed max-w-2xl">
                Diseño geométrico para fachadas modernas,
                integrando protección solar, ventilación y estética arquitectónica.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <p>
                  Esta celosía fue diseñada para aplicaciones en fachadas
                  arquitectónicas modernas, ofreciendo una combinación entre
                  funcionalidad estructural y estética contemporánea.
                </p>

                <p>
                  El patrón geométrico genera una identidad visual elegante,
                  permitiendo controlar entrada de luz y ventilación natural
                  en espacios exteriores.
                </p>

                <p>
                  Fabricada mediante corte CNC de alta precisión para
                  garantizar acabados uniformes y excelente durabilidad
                  en aplicaciones arquitectónicas.
                </p>
              ...
              >
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div className="relative w-full md:w-52 h-40 rounded-2xl overflow-hidden">
                    ...
                    <Image
                      src="/acero_fachada.jpg"
                      alt="Material fachada"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Material diseñado para aplicaciones exteriores
                      gracias a su alta resistencia, durabilidad y acabado
                      uniforme en proyectos arquitectónicos modernos.
                    </p>
        ...
        <section className="px-6 md:px-20 pb-20">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl leading-relaxed">
              ...
              proyectos contemporáneos de gran impacto visual.
            </p>
