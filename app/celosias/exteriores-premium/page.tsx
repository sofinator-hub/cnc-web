          ...
          >
            ...
            <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl p-6 md:p-10 max-w-3xl">
              ...
              <p className="text-gray-200 text-sm md:text-lg leading-relaxed max-w-2xl">
                ...
                combinando funcionalidad, resistencia y estética contemporánea.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <p>
                  Esta celosía fue desarrollada para espacios exteriores
                  contemporáneos, ofreciendo protección visual y una estética
                  arquitectónica elegante.
                </p>

                <p>
                  El diseño geométrico permite controlar entrada de luz
                  y ventilación natural mientras aporta carácter visual
                  a fachadas y áreas abiertas.
                </p>

                <p>
                  Fabricada mediante corte CNC de alta precisión para
                  garantizar resistencia estructural y acabados uniformes
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      exteriores gracias a su durabilidad y excelente
                      comportamiento estructural en ambientes arquitectónicos.
                    </p>
        ...
        <section className="px-6 md:px-20 pb-20">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl leading-relaxed">
              ...
              proyectos modernos y funcionales.
            </p>
