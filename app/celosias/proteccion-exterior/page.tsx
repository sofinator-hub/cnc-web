...
export default function ProteccionExteriorPage() {
  return (
    <>
      <MobileMenu />
          ...
          >
            ...
            <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl p-6 md:p-10 max-w-3xl">
              ...
              <p className="uppercase tracking-[0.3em] text-sm text-gray-200 mb-4">
                Exteriores / Protección arquitectónica
              </p>
              ...
              <p className="text-gray-200 text-sm md:text-lg leading-relaxed max-w-2xl">
                Solución arquitectónica diseñada para brindar protección,
                ventilación y estética contemporánea en espacios exteriores.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <p>
                  Esta celosía fue desarrollada para aplicaciones exteriores
                  donde se requiere protección visual y control solar
                  manteniendo una estética moderna y elegante.
                </p>

                <p>
                  El diseño geométrico permite integrar ventilación natural
                  y privacidad en espacios arquitectónicos contemporáneos
                  sin comprometer iluminación ni amplitud visual.
                </p>

                <p>
                  Fabricada mediante corte CNC de alta precisión para
                  garantizar resistencia estructural, acabados uniformes
                  y larga durabilidad en exteriores.
                </p>
              ...
              >
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div className="relative w-full md:w-52 h-40 rounded-2xl overflow-hidden">
                    ...
                    <Image
                      src="/acero_galvanizado.jpg"
                      alt="Material protección exterior"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div className="w-5 h-5 rounded-full bg-zinc-800 border border-black" />
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Material ideal para aplicaciones exteriores gracias
                      a su resistencia a condiciones ambientales y su excelente
                      desempeño estructural en proyectos arquitectónicos.
                    </p>
        ...
        <section className="px-6 md:px-20 pb-20">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl leading-relaxed">
              ...
              proyectos exteriores contemporáneos.
            </p>
