...
export default function EscalerasPremiumPage() {
  return (
    <>
      <MobileMenu />
          ...
          >
            ...
            <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl p-6 md:p-10 max-w-3xl">
              ...
              <p className="uppercase tracking-[0.3em] text-sm text-gray-200 mb-4">
                Residencial / Escaleras modernas
              </p>
              ...
              <p className="text-gray-200 text-sm md:text-lg leading-relaxed max-w-2xl">
                Diseño decorativo y funcional para protección y estética
                en escaleras arquitectónicas contemporáneas.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <p>
                  Esta celosía fue diseñada para integrarse en escaleras
                  residenciales y arquitectónicas modernas, ofreciendo
                  protección visual y seguridad sin perder ligereza estética.
                </p>

                <p>
                  El diseño geométrico aporta una apariencia contemporánea
                  que complementa interiores modernos y espacios minimalistas.
                </p>

                <p>
                  Fabricada mediante corte CNC de alta precisión para
                  garantizar acabados uniformes, resistencia y una integración
                  visual elegante en proyectos arquitectónicos.
                </p>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Material resistente ideal para aplicaciones
                      arquitectónicas interiores gracias a su durabilidad,
                      precisión en fabricación y acabado contemporáneo.
                    </p>
        ...
        <section className="px-6 md:px-20 pb-20">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl leading-relaxed">
              ...
              proyectos residenciales y contemporáneos.
            </p>
